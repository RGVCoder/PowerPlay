...
const CHAPTERS = [
    ...
    { name: 'Austin Chapter', location: 'Austin, TX' },
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                            {CHAPTERS.map((chapter) => (
                                <div key={chapter.name} className="p-8 bg-gray-50/50 rounded border border-gray-100 transition-colors duration-200 hover:bg-white hover:border-gray-200">
                                    ...
                                    <h3 className="font-display font-semibold text-lg text-charcoal mb-2">{chapter.name}</h3>
                        ...
                        <div className="bg-gray-50/50 rounded p-8 md:p-14 border border-gray-100 overflow-hidden relative group transition-colors duration-300 hover:bg-white">
                            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                                <div className="text-center md:text-left">
                                    <h3 className="font-display font-semibold text-2xl md:text-3xl mb-4 text-charcoal">Want to start a chapter?</h3>
                                ...
                                <Link to="/contact" className="px-10 py-4 bg-coral hover:bg-charcoal text-white rounded-lg font-semibold transition-colors duration-200">

        ...
        <section id="mission" className="py-20 md:py-28 bg-gray-50 relative" data-navbar-theme="light">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-14">
                    ...
                    {/* Large Feature Card */}
                    <div className="md:col-span-7 bg-white rounded-2xl p-6 md:p-8 border border-gray-100 transition-all duration-200 hover:shadow-lg">
                    ...
                    <div className="md:col-span-5 flex flex-col gap-6">
                        <div className="bg-charcoal p-6 text-white flex-1 rounded-2xl transition-all duration-200 hover:shadow-xl hover:-translate-y-1">
                        ...
                        <div className="bg-coral/5 p-6 flex-1 rounded-2xl border border-coral/10 transition-all duration-200 hover:shadow-lg hover:-translate-y-1 hover:bg-coral/10">

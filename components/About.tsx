    ...
    <section id="about" className="py-24 bg-charcoal relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <span className="text-coral text-sm font-semibold uppercase tracking-widest mb-4 block">Our Story</span>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              <strong className="text-coral font-medium">Every dollar we raise goes directly</strong> to supporting kids and families as they navigate the complexities of pediatric illness—from childhood cancer to chronic conditions.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative w-full aspect-square md:aspect-[4/3]">
              ...
              <div className="absolute top-0 left-0 w-3/4 h-3/5 overflow-hidden border-l-4 border-coral shadow-xl z-10 group">

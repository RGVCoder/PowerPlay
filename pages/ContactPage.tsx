                ...
                <section className="py-16 md:py-24 relative">
                    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-charcoal/5">
                            <form
                                action="https://formsubmit.co/powerplaynpo@gmail.com"
                                method="POST"
                                className="space-y-6"
                            >
                                {/* FormSubmit Configuration */}
                                <input type="hidden" name="_subject" value={`New Contact Inquiry: ${topic}`} />
                                <input type="hidden" name="_template" value="table" />
                                <input type="hidden" name="_captcha" value="false" />
                                <input type="hidden" name="_next" value="https://powerplay.org/contact?success=true" /> {/* Update with actual domain if needed, or use autoresponse */}
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-4 rounded-full bg-coral text-white font-bold text-lg shadow-lg shadow-coral/20 hover:shadow-xl hover:translate-y-[-2px] hover:bg-coral-dark transition-all duration-300"
                                >
                                    Send Message
                                </button>
                            </form>
